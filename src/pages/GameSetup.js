...
function GameSetup() {
  ...
  const [linkOne, setLinkOne] = useState("https://isefquiz01.de/quiz?player1=accesstoken1"); // Timelimit to answer a question
  // eslint-disable-next-line
  const [linkTwo, setLinkTwo] = useState("https://isefquiz01.de/quiz?player2=accesstoken2"); // Timelimit to answer a question
  ...
  return (
    <div className="container d-flex justify-content-center align-items-center">
      <div className="col text-center">
        ...
        <GameLinkContainer player="Spieler 1" linkText={linkOne} id="linkText1" />
        <GameLinkContainer player="Spieler 2" linkText={linkTwo}id="linkText2" />
      </div>
    </div>
  );
}
