  ...
  return (
    <div style={styles.container}>
      ...
      <ul class="index">
        ...
        <li>
          <a class="index-link" href="#m432">
            Community Funktionen
          </a>
        </li>
        <li>
          <a class="index-link" href="#m451">
      ...
      <p style={styles.paragraph}>
        ...
        B. mit IT-Aufgaben beauftragte Dienstleister oder Anbieter von Diensten
      ...
      <p style={styles.paragraph}>
        ...
        Inhalte oder verwendete Funktionen eines Onlineangebotes zu speichern.
        Cookies können ferner zu unterschiedlichen Zwecken eingesetzt werden,
        zum Beispiel zu Zwecken der Funktionsfähigkeit, Sicherheit und Komfort
      ...
      <p style={styles.paragraph}>
        ...
        Cookies, unbedingt erforderlich sind, um den Nutzern einen von ihnen
      ...
      <ul style={styles.list}>
        ...
        <li>
          ...
          Kommunikation; Verwaltung und Beantwortung von Anfragen; Feedback (z.
          B. Sammeln von Feedback via Online-Formular). Bereitstellung unseres
